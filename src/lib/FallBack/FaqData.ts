...
export const FAQS: FaqItem[] = [
  ...
  {
    question: "What makes this better than meal vouchers (Essensgutscheine)?",
    answer:
  ...
  {
    question: "How much admin work is involved?",
    answer:
  ...
  {
    question: "Is Bella&Bona a good fit for hybrid or part-time office teams?",
    answer:
